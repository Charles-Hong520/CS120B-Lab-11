 ...
 *
 *  Demo Link: https://drive.google.com/file/d/14o-mjvHz9voRltIF-Mc1zLT7UVcggutA/view?usp=sharing
 */
...
int DisplayTick(int state) {
    switch(state) {
        ...
        state = d_wait;
        LCD_ClearScreen();
        LCD_DisplayString(1,"Around the world around the w...");
        break;
        case dis:
        if(canWrite) {
